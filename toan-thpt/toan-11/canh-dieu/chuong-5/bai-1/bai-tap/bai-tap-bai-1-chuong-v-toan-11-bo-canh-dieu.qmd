...
::: {.alert .alert-info} 
Đây là các bài tập của Bài 1: *Các số đặc trưng đo xu thế trung tâm cho mẫu số liệu ghép nhóm*, Chương V: *Một số yếu tố thống kê và xác suất*, bộ *Cánh Diều*, Toán 11 (trang 14, tập 2).
:::
