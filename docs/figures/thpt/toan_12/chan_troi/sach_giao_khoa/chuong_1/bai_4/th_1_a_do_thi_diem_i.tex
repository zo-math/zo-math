...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node at (-1/2,0) [below left] {$-\frac{1}{2}$};
    ...
    \addplot[only marks, mark=*, mark size=2pt, color=do-2] coordinates {
        (-1/2,1/2)
        (-1.5,1)
        (1/2,0)
        };
    ...
    % Tiếp tuyến
    \addplot[do-2, opacity=.8, line width=1.5pt, domain=-1.75:-1.25] {-(9/2)*x -23/4}; 
    \addplot[do-2, opacity=.8, line width=1.5pt, domain=.25:.75] {-(9/2)*x+9/4}; 
    \addplot[xanh-2, opacity=.8, line width=1.5pt, domain=-.9:-.1] {(3/2)*x+5/4}; 
