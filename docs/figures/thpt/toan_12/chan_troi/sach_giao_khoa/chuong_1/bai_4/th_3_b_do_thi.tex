...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \node at (axis cs:0,6) [right] {$6$};
    \node at (axis cs:0,5) [right] {$5$};
    \node at (axis cs:0,3) [right] {$3$};
    \node at (axis cs:0,1.35) [left] {$1$};
    \node at (axis cs:-1.5,0) [above] {$-1$};
    \node at (axis cs:-2.6,0) [above] {$-2$};
    \node at (axis cs:1.6,0) [above right] {$\frac{1+\sqrt{5}}{2}$};
    \node at (axis cs:-.6,0) [below left] {$\frac{1-\sqrt{5}}{2}$};
    \node at (axis cs:-3.6,0) [below left] {$-\frac{5+\sqrt{5}}{2}$};
