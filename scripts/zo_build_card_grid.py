...
NUM_OVERRIDES: Dict[int, Dict[str, Any]] = {
    ...
    106: {"expr": "asin(x)", "xlim": (-1, 1), "ylim": (-1.8, 1.8)},
    ...
    129: {"expr": "x*sin(x)", "xlim": (-6.283185307, 6.283185307), "ylim": (-6.5, 6.5), "samples": 1600},
    130: {"expr": "sinc(x)", "xlim": (-10, 10), "ylim": (-0.35, 1.1), "samples": 1800},
    132: {"expr": "x+sin(x)", "xlim": (-5, 5), "ylim": (-6, 6), "samples": 1400},
    133: {"expr": "log(sin(x))", "xlim": (0.05, 3.091592654), "ylim": (-4, 0.2), "breaks": [0, 3.141592654], "samples": 1400},
    ...
    145: {"expr": "exp(-exp(-x))", "xlim": (-4, 4), "ylim": (-0.1, 1.1)},
