...
## Bước hậu commit — chưa thực hiện

- [ ] Commit hồ sơ phát hành O4 từ worktree sạch.
- [ ] Chạy lại doctor và regression tại commit cuối.
- [ ] Tạo release candidate `qmd-ops-v0.4.0-rc.zip` ngoài repository.
- [ ] Xác minh bằng CLI ngoài gói.
- [ ] Xác minh bằng CLI tự chứa trong payload.
- [ ] Ghi candidate commit, package ID và SHA-256 của ZIP.
- [ ] Xác nhận không tạo Git tag thật.
- [ ] Xác nhận không push hoặc publish.
