...
\begin{tikzpicture}
  \begin{axis}[
    ...
    samples=350, line width=1.5pt, color=den-2, opacity=.5] 
        {-x+1};
    \addplot[dashed, smooth, line width=1.5pt, color=den-2, opacity=.5] coordinates {
        (1/3,-2)
        (1/3,3)
        };
    \addplot[dashed, smooth, line width=1.5pt, color=den-2, opacity=.5] coordinates {
