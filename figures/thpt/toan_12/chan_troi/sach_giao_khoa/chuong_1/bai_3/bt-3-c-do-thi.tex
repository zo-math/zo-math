...
\begin{tikzpicture}
  ...
  \node at (axis cs:0,1) [anchor=south west] {\footnotesize$1$};
  
  \addplot[domain=-5:5, color=den-2, line width=1.5pt, opacity=.8] {(16*x^2-8*x)/(16*x^2+1)};
  
  \addplot[dashed, smooth, domain=-5:5, color=den-2, line width=1.5pt, opacity=.8] coordinates {(-5,1) (5,1)};
