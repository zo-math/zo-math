...
::: {.col-translation}
Phần lớn toán học, đặc biệt là các lĩnh vực số và đo lường, khởi nguồn từ những nỗ lực định lượng thế giới. Số và đo lường, vốn được chú trọng mạnh mẽ từ mẫu giáo đến lớp 8, là nền tảng cho toán học bậc trung học phổ thông; nếu thiếu kỹ năng luận trong các lĩnh vực này, học sinh sẽ bị hạn chế trong luận ở các lĩnh vực toán học khác.
:::
...
::: {.col-translation}
Các yếu tố then chốt của luận và hiểu với số và đo lường bao gồm:

* *Tính hợp lý của đáp số và phép đo.* Đánh giá xem một đáp số hoặc một phép đo có bậc độ lớn thích hợp hay không, và có được biểu diễn bằng đơn vị phù hợp hay không.
* *Xấp xỉ và sai số.* Nhận ra rằng mọi phép đo trong thế giới thực đều chỉ là những giá trị xấp xỉ, nên không được dùng những giá trị có độ chính xác không thích hợp để biểu diễn các đại lượng thực tế; đồng thời thấy được vai trò của sai số trong các phép tính tiếp theo với các phép đo ấy.
* *Hệ thống số.* Hiểu sâu các tính chất của các hệ thống số; mở rộng các tính chất đó sang các tình huống đại số.
* *Đếm.* Nhận biết khi nào việc liệt kê là một phương pháp hiệu quả để giải quyết vấn đề, rồi vận dụng các nguyên lý và kỹ thuật đếm để tìm lời giải.

Chúng tôi sẽ trình bày chi tiết hơn các yếu tố then chốt này trong những phần tiếp theo.
:::

::: {.col-notes}
Tác giả đang dựng khung cho toàn bộ phần bàn về số và đo lường bằng bốn yếu tố then chốt: đánh giá tính hợp lý, ý thức về xấp xỉ và sai số, hiểu cấu trúc của các hệ thống số, và nhận ra khi nào đếm là một con đường giải quyết thích hợp. Trọng tâm không nằm ở việc nêu thêm các mảng nội dung quen thuộc của chương trình, mà ở việc xác định những phương thức luận và hiểu cần hiện diện khi học số và đo lường. Nhờ đó, các phần sau của chương được đọc như sự triển khai của một khung năng lực, không phải như một danh sách chủ đề rời nhau.
:::
...
::: {.col-translation}
### Tính hợp lý các đáp số và phép đo
:::
...
Teacher:
: What would you predict the total surface area of the earth is?

Student 1:
: Wow, I would have no idea. I’d guess either a million or maybe a billion square miles.

Student 2:
: Well, it is a ball, which is basically a sphere. So if we knew the radius, I guess we could figure that out.

Teacher:
: OK, to help you out, I’ll tell you that its radius is about $4,000$ miles.

Student 2:
: So then $A = 4\pi r^2$ , and we just need to plug the radius in.

Student 3:
: If the radius is about $4$ thousand, then squaring will take us to about $16$ million. And $4\pi$ is a little more than $12$, and $12 \times 16 = 192$, so I’ll guess maybe $200$ million square miles.

Student 4:
: Yeah, that’s decent, but why not just use the π-button on your calculator? That’s what I did, and I got $201,061,930$.

Teacher:
: So which do you think is the best estimate?

Student 4:
: Mine, because it’s most accurate.

Student 3:
: But we don’t know exactly what the radius of the earth is. Besides, the earth may not be exactly spherical. Your number is within $1$ percent of $200,000,000$, so I think $200,000,000$ is good enough.
...
Giáo viên:
Em dự đoán tổng diện tích bề mặt Trái Đất vào khoảng bao nhiêu?

Học sinh 1:
Ôi, em không có ý niệm gì cả. Em đoán chắc khoảng một triệu, hoặc có khi là một tỉ dặm vuông.

Học sinh 2:
À, Trái Đất là một khối tròn, về cơ bản là một hình cầu. Vậy nếu biết bán kính thì em nghĩ mình có thể tính được.

Giáo viên:
Được, để hỗ trợ các em, thầy cho biết bán kính của nó vào khoảng $4\,000$ dặm.

Học sinh 2:
Vậy thì $A = 4\pi r^2$, mình chỉ cần thay bán kính vào thôi.

Học sinh 3:
Nếu bán kính cỡ $4$ nghìn, thì bình phương lên sẽ vào khoảng $16$ triệu. Mà $4\pi$ lớn hơn 12 một chút, còn $12 \times 16 = 192$, nên em đoán chắc khoảng $200$ triệu dặm vuông.

Học sinh 4:
Ừ, cách đó cũng ổn, nhưng sao không bấm luôn nút $\pi$ trên máy tính? Em làm vậy và ra $201\,061\,930$.

Giáo viên:
Vậy theo các em, đâu là ước lượng tốt nhất?

Học sinh 4:
Số của em, vì nó chính xác nhất.

Học sinh 3:
Nhưng mình đâu có biết chính xác bán kính Trái Đất là bao nhiêu. Với lại, Trái Đất cũng chưa chắc là một khối cầu hoàn hảo. Số của bạn chỉ lệch chưa đến $1$ phần trăm so với $200\,000\,000$, nên em nghĩ $200\,000\,000$ là đủ tốt rồi.

:::

**Các yếu tố toán học liên quan**

Lập luận với Số và Đo lường --- Tính hợp lý của đáp số và phép đo; Xấp xỉ và sai số.

**Thói quen luận**

Phân tích một vấn đề --- đưa ra dự đoán ban đầu và các suy luận sơ khởi.

Phản tư về lời giải --- đánh giá tính hợp lý của đáp số; biện minh lời giải.
:::
...
::: {.col-translation}
Năng lực trực giác số học tạo ra một nền tảng quan trọng cho việc học toán ở bậc trung học phổ thông. Báo cáo của National Mathematics Advisory Panel (2008) ghi nhận rằng “khả năng cảm số yếu kém gây cản trở việc học các thuật toán và các sự kiện số học, đồng thời khiến học sinh không thể sử dụng các chiến lược để kiểm tra xem lời giải của một bài toán có hợp lý hay không” (tr. 27). Báo cáo tiếp tục nhấn mạnh tầm quan trọng của việc phát triển cả hiểu biết khái niệm lẫn hiểu biết thủ tục về phân số để tiến bộ trong toán học, cùng với “những khó khăn lan tỏa” (tr. 28) mà học sinh thường gặp. Mặc dù thời lượng dạy học không cho phép dạy lại toàn bộ các khái niệm và phép tính về số mà học sinh *đáng lẽ* đã nắm vững khi vào trung học phổ thông, nhưng việc chú trọng đến năng lực cảm số hoàn toàn có thể được tích hợp hiệu quả vào mục tiêu giảng dạy. Chẳng hạn, giáo viên có thể thường xuyên yêu cầu học sinh xác định xem kết quả của một phép tính đã cho có đúng cấp độ lớn hay không, hoặc mức độ chính xác nào là thích hợp đối với một đáp số, rồi trình bày lập luận làm căn cứ cho phán đoán ấy.
:::
...
![](figures/fhsm_2009_p24_f1){fig-align="center"}
...
::: {.col-translation}
#### Ví dụ 2: Nhiên liệu để tư duy

**Nhiệm vụ**

Một giáo viên đưa cho học sinh bài trắc nghiệm sau đây, được trích từ một bài báo trên New York Times (Chang 2008), và yêu cầu các em giải thích lập luận của mình:

::: {.indent-left}

**Câu hỏi trắc nghiệm:** Trường hợp nào sau đây sẽ tiết kiệm được nhiều nhiên liệu hơn?

a. Thay một chiếc xe cỡ nhỏ đi được $34$ dặm trên mỗi ga-lông (MPG) bằng một chiếc xe lai đi được $54$ MPG.
b. Thay một chiếc thể thao đa dụng (SUV) đi được $18$ MPG bằng một chiếc xê-đan đi được $28$ MPG.
c. Cả hai sự thay đổi đều tiết kiệm được cùng một lượng nhiên liệu.
...
![](figures/fhsm_2009_p24_f1_vi){fig-align="center"}
...
>
> *Great idea! But you could explain this a little more fully.*
>
> *Why did you change to less? Why was that important? Is this the exact value? Continue your argument using bounds. Is this relative error? Have you really made your point with this example? How does using the $\pi$-button relate to the value of $V$?*
...
Việc giúp học sinh vượt qua quan niệm rằng sai số là một lỗi sai là một phần quan trọng của quá trình kiến tạo ý nghĩa, để có một thảo luận hiệu quả về sai số. Học sinh thường xem sai số như *mức độ cách xa câu trả lời đúng*. Giáo viên có thể dựa trên quan niệm này để thảo luận về *sai số* như hiệu giữa giá trị xấp xỉ $(v)$ và “giá trị thật” $(V)$, và *sai số tuyệt đối* là giá trị tuyệt đối (độ lớn) của sai số, $\lvert V - v\rvert$. Việc hình thành hiểu biết về *sai số tương đối* như là một tỉ lệ phần trăm của “giá trị thật” có thể giúp học sinh hiểu được công thức sai số tương đối, $\frac{\lvert V - v\rvert}{V}$. Để hiểu rõ hơn mức độ tiến bộ của học sinh trong việc nắm bắt khái niệm sai số tương đối, giáo viên giao nhiệm vụ “Quanh số $\pi$” như một bài đánh giá ngay trên lớp, yêu cầu học sinh làm cá nhân. Sau đây là lời giải của một học sinh, kèm theo nhận xét bên lề của giáo viên:
...
>
> *Ý tưởng rất hay! Nhưng em có thể giải thích đầy đủ hơn một chút.*

> *Tại sao em lại chuyển sang dùng một giá trị nhỏ hơn? Điều đó quan trọng ở chỗ nào? Đây có phải là giá trị chính xác không? Hãy tiếp tục lập luận bằng cách dùng các cận trên/dưới. Đây có thực sự là sai số tương đối không? Ví dụ cuối cùng của em đã làm rõ được luận điểm của mình chưa? Việc dùng nút $\pi$ trên máy tính liên quan thế nào đến giá trị $V$?*

**Yếu tố Toán học then chốt**

Luận với Số và Đo lường --- Xấp xỉ và sai số

**Thói quen luận**

Phân tích một vấn đề --- xác định các biến và điều kiện liên quan  

Triển khai một chiến lược --- theo dõi tiến trình hướng tới lời giải  

Phản tư về lời giải --- biện minh hoặc kiểm chứng lời giải; tinh chỉnh lập luận
:::
...
**Bài tập.** Hãy sử dụng bất đẳng thức $3.1415<\pi<3.1416$ để xây dựng thêm một lập luận.
:::
...
![](figures/fhsm_2009_p27_1){fig-align="center"}
...
![](figures/fhsm_2009_p28_1){fig-align="center"}
...
![](figures/fhsm_2009_p28_2){fig-align="center"}
...
::: {.col-translation}
#### Ví dụ 4: Một ý tưởng mô hình

**Bối cảnh**

Tính phân phối có thể được minh họa bằng một *mô hình diện tích*. Chẳng hạn, xét tích của 62 và 43. Nếu mỗi thừa số được viết dưới dạng khai triển, ta có
...
Khi ý tưởng dùng diện tích để mô hình hóa phép nhân số nguyên đã được hình thành (lý tưởng là từ bậc tiểu học đến THCS), các mô hình diện tích có thể giúp học sinh hiểu nhiều quy trình khác, chẳng hạn như phép nhân phân số và phép nhân đa thức.
...
Luận với Số và Đo lường --- Hệ thống số

**Thói quen luận**

Phân tích vấn đề --- nhận diện các khái niệm, quy trình hoặc biểu diễn liên quan; vận dụng các khái niệm đã học  
