...
format:
  ...
  pdf:
    ...
    pdf-engine-opts:
      - "-shell-escape" # Cho phép LaTeX chạy các lệnh hệ thống (như gọi chương trình bên ngoài).
      - "-file-line-error" # Chỉ ra tệp nào, dòng nào bị lỗi.
...
> **Tóm tắt nội dung.** Bài viết đi sâu vào từng chi tiết của quá trình khai triển biểu thức $(1+x)^n$ thành đa thức 

$$
1+nx+\frac{(n-1)n}{2}x^2+\frac{(n-2)(n-1)n}{6}x^3+\cdots+x^n
$$

bằng quy tắc nhân phân phối. Quy tắc này được áp dụng khéo léo vào các trường hợp đơn giản, kèm theo sơ đồ minh họa phù hợp, làm xuất hiện các hình mẫu cần thiết để diễn giải định lý nhị thức. Sự xuất hiện tự nhiên của tam giác <span data-bs-toggle="tooltip" title="Pascal">Pát-si-cao</span>, nổi tiếng là một hình mẫu để tính các hệ số nhị thức, đã minh chứng cho sự khéo léo này. Bài viết không chỉ truyền đạt kiến thức kỹ thuật, mà còn thúc đẩy khả năng tư duy hợp lý và sáng tạo trong nghiên cứu, từ khi phát hiện đến khi hoàn thiện một vấn đề toán học.
:::

::: {.content-visible when-format="pdf"}
\begin{abstract}
Bài viết đi sâu vào từng chi tiết của quá trình khai triển biểu thức $(1+x)^n$ thành đa thức 

$$
    1+nx+\frac{(n-1)n}{2}x^2+\frac{(n-2)(n-1)n}{6}x^3+\cdots+x^n
$$

bằng quy tắc nhân phân phối. Quy tắc này được áp dụng khéo léo vào các trường hợp đơn giản, kèm theo sơ đồ minh họa phù hợp, làm xuất hiện các hình mẫu cần thiết để diễn giải định lý nhị thức. Sự xuất hiện tự nhiên của tam giác Pát-si-cao\footnote{Pascal}, nổi tiếng là một hình mẫu để tính các hệ số nhị thức, đã minh chứng cho sự khéo léo này. Bài viết không chỉ truyền đạt kiến thức kỹ thuật, mà còn thúc đẩy khả năng tư duy hợp lý và sáng tạo trong nghiên cứu, từ khi phát hiện đến khi hoàn thiện một vấn đề toán học.
\end{abstract}
:::
...
![Sơ đồ nhân phân phối $1+x$ với $p_1$ thu được $p_2$.](/figures/toan-tai-hien/khai-trien-luy-thua-nhi-thuc-thanh-da-thuc/so-do-nhan-phan-phoi-hai-nhi-thuc){#fig-so-do-nhan-phan-phoi-hai-nhi-thuc}
...
![Sơ đồ nhân phân phối $1+x$ với $p_2$ thu được $p_3$.](/figures/toan-tai-hien/khai-trien-luy-thua-nhi-thuc-thanh-da-thuc/so-do-nhan-phan-phoi-nhi-thuc-voi-tam-thuc){#fig-so-do-nhan-phan-phoi-nhi-thuc-voi-tam-thuc}
...
![Sơ đồ nhân phân phối $1+x$ với $p_0$, $p_1$, $p_2$,$p_3$, $p_4$ thu được $p_5$.](/figures/toan-tai-hien/khai-trien-luy-thua-nhi-thuc-thanh-da-thuc/thap-nhan-phan-phoi-den-n-bang-5){#fig-thap-nhan-phan-phoi-den-n-bang-5}
...
![Trong các văn bản toán học, tháp này thường được gọi là tam giác <span data-bs-toggle="tooltip" title="Pascal">Pát-si-cao</span>, xem <a href="#bibliography"><span class="citation" data-key="ref1">Edwards (2019)</span></a>.](/figures/toan-tai-hien/khai-trien-luy-thua-nhi-thuc-thanh-da-thuc/thap-he-so-nhi-thuc-den-n-bang-9){#fig-thap-he-so-nhi-thuc-den-n-bang-9}

![Tháp hệ số nhị thức dạng kí hiệu.](/figures/toan-tai-hien/khai-trien-luy-thua-nhi-thuc-thanh-da-thuc/thap-he-so-nhi-thuc-dang-ki-hieu-den-n-bang-9){#fig-thap-he-so-nhi-thuc-dang-ki-hieu-den-n-bang-9}
