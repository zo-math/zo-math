...
\hypersetup{
  pdftitle={Bài tập cuối chương V},
  pdfauthor={ZO \textbar{} r Sys.Date()},
  pdflang={vi},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\makeatother
\subtitle{Toán 11 \textbar{} Cánh Diều \textbar{} Sách lý thuyết}
\author{ZO \textbar{} \texttt{r\ Sys.Date()}}
\date{}
