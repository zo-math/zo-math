...
subtitle: 'Đi qua điểm dừng tại gốc mà không đổi chiều biến thiên'
pagetitle: "Hàm số y = x³"

summary: 'Ở hàm số $y=x^3$, đạo hàm bằng $0$ tại gốc nhưng hàm vẫn đồng biến nghiêm ngặt. Từ dấu của $y^\prime$ đến sự biến thiên của chính $y^\prime$, bài viết làm rõ vì sao đồ thị không quay đầu mà đổi tính cong tại $O$, rồi soi lại cấu trúc ấy qua hàm ngược $y=\sqrt[3]{x}$.'
description: 'Độ dốc của đồ thị $y=x^3$ giảm dần về $0$ khi tiến đến gốc rồi tăng trở lại, nhưng đồ thị vẫn đi lên và không quay đầu. Điều gì phân biệt một điểm dừng với một điểm cực trị? Bài viết lần theo dấu của $y^\prime$, sự biến thiên của $y^\prime$ và dấu của $y^{\prime\prime}$ để làm rõ điểm uốn tại gốc, rồi nhìn lại những quan hệ ấy qua hàm ngược $y=\sqrt[3]{x}$.'

image: /content/thpt/zo_math_100/100_ham_so_su_bien_thien_va_do_thi/assets/img/cards/the_024.svg
listing-order: 24

abstract: |
  Hàm số $y=x^3$ cho thấy một điểm có đạo hàm bằng $0$ không nhất thiết là nơi hàm số đổi chiều biến thiên. Bài viết bắt đầu từ cấu trúc đại số của $x^3$, dấu và độ lớn của giá trị hàm số, rồi chứng minh trực tiếp tính đồng biến nghiêm ngặt trước khi dùng đạo hàm để khảo sát sâu hơn. Tại gốc tọa độ, $y^\prime(0)=0$ tạo ra một tiếp tuyến nằm ngang, nhưng $y^\prime$ không đổi dấu nên hàm số vẫn tiếp tục đồng biến. Trong khi đó, $y^\prime$ giảm về $0$ rồi tăng trở lại; tương ứng, $y^{\prime\prime}$ đổi dấu qua $0$ và đồ thị chuyển từ cong xuống sang cong lên. Sự phân biệt giữa chiều biến thiên và tính cong làm rõ vì sao $O$ là điểm uốn nhưng không phải điểm cực trị. Cuối cùng, các quan hệ ấy được soi lại qua hàm ngược $y=\sqrt[3]{x}$.
...
f(-x)=(-x)^3=-x^3=-f(x),
$$
nên $y=x^3$ là hàm số lẻ và đồ thị đối xứng qua gốc tọa độ $O(0,0)$. Đối xứng này giúp ta khôi phục nửa đồ thị bên trái từ nửa bên phải. Tuy nhiên, những kết luận toàn cục đối với hàm số lẻ vẫn cần được kiểm tra trên toàn miền, chứ không chỉ dựa vào hình đối xứng.
...
y^{\prime\prime}=6x.
$$
Khi $x<0$, ta có $y^{\prime\prime}<0$, nên $y^\prime$ giảm; khi $x>0$, ta có $y^{\prime\prime}>0$, nên $y^\prime$ tăng. Đạo hàm bậc hai vì thế cho phép nhận biết nhanh sự thay đổi của độ dốc mà trước đó ta đã thấy trực tiếp từ bất đẳng thức. Khi tiến đến gốc từ bên trái, đồ thị vẫn đi lên nhưng ngày càng phẳng; sau khi đi qua gốc, nó tiếp tục đi lên và ngày càng dốc hơn. Nói theo tính cong, đồ thị chuyển từ cong xuống sang cong lên tại $O$; đây chính là cơ chế hình học của điểm uốn tại gốc.
