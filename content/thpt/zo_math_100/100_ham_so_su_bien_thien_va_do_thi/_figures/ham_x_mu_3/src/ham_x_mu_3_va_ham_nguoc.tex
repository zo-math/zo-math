...
\begin{axis}[
    ...
    \node[zo graph label, text=zoGraphMain, anchor=west, xshift=4pt, yshift=4pt]
      at (axis cs:1.12,1.42) {$y=x^3$};

    \node[zo graph label, text=zoGraphSecondary, anchor=west, xshift=4pt, yshift=-2pt]
      at (axis cs:1.55,1.16) {$y=\sqrt[3]{x}$};

    \node[zo graph label, text=zoReference, anchor=south east, xshift=-2pt, yshift=2pt]
      at (axis cs:-1.65,-1.65) {$y=x$};

    \node[zo graph label, text=zoGraphMain, anchor=south, yshift=4pt]
      at (axis cs:0.72,0) {$y=0$};

    \node[zo graph label, text=zoGraphSecondary, anchor=west, xshift=4pt]
