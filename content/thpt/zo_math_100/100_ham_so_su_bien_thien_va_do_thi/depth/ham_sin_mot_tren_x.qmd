...
![](../_figures/do_thi_ham_sin_mot_tren_x/svg/do_thi_ham_sin_mot_tren_x_phong_dai_02.svg){width=100% fig-align="center"}
...
![](../_figures/do_thi_ham_sin_mot_tren_x/pdf/do_thi_ham_sin_mot_tren_x_phong_dai_01.pdf){width=85% fig-align="center"}
...
Sự thất bại của giới hạn tại $0$ vì thế không chỉ được thể hiện qua hai mức $-1$ và $1$. Tùy theo dãy đầu vào được chọn, đồ thị có thể liên tục trở lại bất kì độ cao nào trong toàn bộ dải $[-1,1]$.
