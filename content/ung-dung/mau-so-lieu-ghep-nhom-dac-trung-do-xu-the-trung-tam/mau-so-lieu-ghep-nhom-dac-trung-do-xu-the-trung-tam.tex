...
\hypersetup{
  pdftitle={Số đặc trưng độ xu thế trung tâm - Thống kê lớp 11},
  pdflang={vi},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{Số đặc trưng độ xu thế trung tâm - Thống kê lớp 11}
\author{}
\date{}
...
Ứng dụng này giúp bạn tính toán các số đặc trưng đo xu thế trung tâm như
trung bình, trung vị, tứ phân vị và mốt cho dữ liệu ghép nhóm.
