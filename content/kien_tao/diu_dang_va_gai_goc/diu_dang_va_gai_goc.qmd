...
![Sơ đồ nhân phân phối <span class="math">\\(1+x\\)</span> với <span class="math">\\(p_1\\)</span> thu được <span class="math">\\(p_2\\)</span>.](/figures/zo_o/diu_dang_va_gai_goc/so_do_nhan_phan_phoi_hai_nhi_thuc){#fig-so-do-nhan-phan-phoi-hai-nhi-thuc fig-alt="Sơ đồ nhân phân phối hai nhị thức bậc nhất để thu được một tam thức bậc hai."}
...
![Sơ đồ nhân phân phối <span class="math">\\(1+x\\)</span> với <span class="math">\\(p_2\\)</span> thu được <span class="math">\\(p_3\\)</span>.](/figures/zo_o/diu_dang_va_gai_goc/so_do_nhan_phan_phoi_nhi_thuc_voi_tam_thuc){#fig-so-do-nhan-phan-phoi-nhi-thuc-voi-tam-thuc}
...
![Sơ đồ nhân phân phối <span class="math">\\(1+x\\)</span> với <span class="math">\\(p_0\\)</span>, <span class="math">\\(p_1\\)</span>, <span class="math">\\(p_2\\)</span>, <span class="math">\\(p_3\\)</span>, <span class="math">\\(p_4\\)</span> thu được <span class="math">\\(p_5\\)</span>.](/figures/zo_o/diu_dang_va_gai_goc/thap_nhan_phan_phoi_den_n_bang_5){#fig-thap-nhan-phan-phoi-den-n-bang-5}
...
::: {layout-ncol=2}
![Trong các văn bản toán học, tháp này thường được gọi là tam giác <span data-bs-toggle="tooltip" title="Pascal">Pát-si-cao</span> [@edwards2019pascal].](/figures/zo_o/diu_dang_va_gai_goc/thap_he_so_nhi_thuc_den_n_bang_9){#fig-thap-he-so-nhi-thuc-den-n-bang-9}

![Tháp hệ số nhị thức dạng kí hiệu.](/figures/zo_o/diu_dang_va_gai_goc/thap_he_so_nhi_thuc_dang_ki_hieu_den_n_bang_9){#fig-thap-he-so-nhi-thuc-dang-ki-hieu-den-n-bang-9}
:::
...
![Một cách viết khác của tam giác <span data-bs-toggle="tooltip" title="Pascal">Pát-si-cao</span>.](/figures/zo_o/diu_dang_va_gai_goc/thap_he_so_nhi_thuc_dang_tam_giac_vuong_den_n_bang_9){#fig-thap-he-so-nhi-thuc-dang-tam-giac-vuong-den-n-bang-9}
...
::: {#exr-5}
Cho $n$ là số nguyên không âm, chứng minh rằng khi $n$ tăng vô hạn, $\sum_{j=0}^n\frac{1}{j!}$ và $\left(1+\frac{1}{n}\right)^n$ cùng hội tụ về một giới hạn. Được biết giới hạn đó chính là số $\operatorname{e}=2,718\ldots$.
:::
